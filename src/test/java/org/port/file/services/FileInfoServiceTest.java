...
import org.port.file.exceptions.FileNotFoundException;
...
public class FileInfoServiceTest {
    ...
    @Test
    @DisplayName("없는 파일 번호로 조회 시 FileNotFoundException이 발생하는지 테스트")
    void notExistsFileInfoTest() {
        // FileNotFoundException 예외가 발생했으므로 테스트 성공
        // 테스트 성공 시 발생된 예외가 반환
