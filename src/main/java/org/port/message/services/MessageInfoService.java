...
import org.port.message.entities.QMessage;
import org.port.message.exceptions.MessageNotFoundException;
...
public class MessageInfoService {
    ...
    public ListData<Message> getList(MessageSearch search) {
        ...
        if (mode.equals("send")) {
            ...
            BooleanBuilder orBuilder = new BooleanBuilder();
            BooleanBuilder andBuilder1 = new BooleanBuilder(); // 관리자 공지
